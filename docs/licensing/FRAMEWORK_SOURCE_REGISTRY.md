...
provider discussions. It is kept **outside this repository entirely** — not merely gitignored — and
nothing from it is copied into public documentation, samples, fixtures, packages or source tarballs.
The gate refuses to see any such material tracked here.

The location is not named publicly. A public document describing where private material is kept adds
nothing a reader needs and is operational detail (`PUBLIC-OPS-001`).
